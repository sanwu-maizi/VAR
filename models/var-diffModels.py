...
class VAR(nn.Module):
    ...
    def autoregressive_infer_cfg(
        ...
        if is_return_raw:
            ...
            segments_end = len(self.patch_nums) //2 + 1
        
        # segments_start = 0
        # segments_end = len(self.patch_nums)
            
        # print(cur_L,f_hat,next_token_map,segments_start,segments_end)
        ...
        for si, pn in enumerate(self.patch_nums[segments_start:segments_end]):   # si: i-th segment
            ...
            print(f_hat[0][0][0],cond_BD_or_gss[0],next_token_map[0][0][0],h_BChw[0][0][0],logits_BlV[0][0][0])
